...
if (is.character(data[[cfg$mapping$x]])) {
    data[[cfg$mapping$x]] <- reorder_var(data, cfg$mapping$x, cfg$mapping$y)
}

if (is.character(data[[cfg$mapping$y]])) {
    data[[cfg$mapping$y]] <- reorder_var(data, cfg$mapping$y, cfg$mapping$x)
}
